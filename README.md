...
- [vscodev/neokikoeru](https://github.com/vscodev/neokikoeru) - Alternative to Kikoeru, Neokikoeru is a fast, robust and user-friendly self-hosted streaming media server for DLsite voice works.
